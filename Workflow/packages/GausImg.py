...
def ic(path): #Counts the amount of images for an automated count for the following while loop.
    """
...
def GT(path):
    ...
    while i <= ic(path): #Counts all the images and sets the boundary value for the while loop.
